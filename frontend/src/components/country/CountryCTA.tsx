      ...
      <Container size="lg">
        <div className="relative overflow-hidden rounded-3xl bg-[linear-gradient(135deg,#12204C_0%,#253A7B_50%,#1B2958_100%)] px-6 py-16 text-center text-white sm:px-16 sm:py-20 shadow-2xl">
          ...
          <div className="relative mx-auto max-w-3xl">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-4 py-1.5 font-dmsans text-xs font-semibold tracking-wide text-white backdrop-blur-md border border-white/20">
              <ShieldCheck size={15} className="text-[#E93F61]" />
              Official Partner of Accredited {country.name} Universities
            </span>

            <h2 className="mt-6 font-hedvig text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl leading-tight">
              Ready to Study in {country.name}?
            </h2>

            <p className="mt-4 font-dmsans text-base text-white/85 sm:text-lg max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
              <LeadCTAButton
                ...
                className="inline-flex h-12 items-center gap-2.5 rounded-full bg-[#E93F61] px-8 font-dmsans text-[15px] font-semibold text-white shadow-xl transition-all duration-300 hover:bg-[#d93657] hover:scale-105 active:scale-95 cursor-pointer"
              >
              ...
              <Link
                ...
                className="inline-flex h-12 items-center gap-2 rounded-full border border-white/30 bg-white/10 px-7 font-dmsans text-[15px] font-semibold text-white backdrop-blur-xs transition-all duration-300 hover:bg-white/20 active:scale-95"
              >
                <Compass size={17} />
