...
export default function SuccessStories() {
    return (
        <section className="w-full bg-surface-subtle py-16 md:px-8 lg:py-20 tracking-tight-5 [letter-spacing:var(--tracking-tight-5)] [&_*]:[letter-spacing:var(--tracking-tight-5)]">
            <div className="mx-auto flex max-w-[1320px] flex-col items-center">
                ...
                <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row lg:mt-8">
                    ...
                    <Link
                        ...
                        className="group inline-flex h-12 cursor-pointer items-center gap-2 rounded-full px-6 text-btn font-semibold text-brand-accent transition-all duration-200 hover:bg-brand-accent/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2"
                    >
