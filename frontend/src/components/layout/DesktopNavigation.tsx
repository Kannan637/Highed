  ...
  return (
    ...
    >
        ...
        return (
          ...
          >
            <button
              ...
              className={`flex h-full items-center gap-1.5 font-dmsans text-[16px] font-medium leading-[24px] tracking-[-0.04em] transition-colors duration-200 cursor-pointer ${
      ...
      <Link
        href="/blog"
        onClick={handleClose}
        className={`flex h-full items-center font-dmsans text-[16px] font-medium leading-[24px] tracking-[-0.04em] transition-colors duration-200 cursor-pointer ${
      ...
      <button
        ...
        className="ml-2 flex h-[46px] items-center gap-3 rounded-full bg-[#E93F61] pl-5 pr-1.5 font-dmsans text-[16px] font-semibold leading-[24px] tracking-[-0.04em] text-white shadow-sm transition-all duration-200 hover:bg-[#D93657] active:scale-[0.98] cursor-pointer"
      >
