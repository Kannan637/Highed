      ...
      <Container size="md">
        ...
        <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-xs sm:p-12">
          ...
          <div className="prose prose-slate mt-8 max-w-none font-body text-base leading-relaxed text-gray-700">
            ...
            <h2 className="mt-8 text-xl font-bold text-content-primary">1. Acceptance of Terms</h2>
            <p>
            ...
            <h2 className="mt-8 text-xl font-bold text-content-primary">2. Advisory Services & Scope</h2>
            <p>
            ...
            <h2 className="mt-8 text-xl font-bold text-content-primary">3. Student Responsibilities</h2>
            ...
            <h2 className="mt-8 text-xl font-bold text-content-primary">4. Intellectual Property</h2>
            <p>
            ...
            <h2 className="mt-8 text-xl font-bold text-content-primary">5. Disclaimer & Limitation of Liability</h2>
            <p>
            ...
            <h2 className="mt-8 text-xl font-bold text-content-primary">6. Third-Party Links</h2>
            <p>
            ...
            <h2 className="mt-8 text-xl font-bold text-content-primary">7. Governing Law</h2>
            <p>
            ...
            <h2 className="mt-8 text-xl font-bold text-content-primary">8. Contact Us</h2>
            ...
            <div className="mt-4 rounded-2xl bg-[#F8F9FE] p-6 text-sm text-gray-700">
              <p className="font-semibold text-content-primary">{siteConfig.name} Legal & Compliance</p>
