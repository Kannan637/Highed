...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#FAFAFC] px-5 text-center font-dmsans">
      <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-[#EEF1FA]">
        <Search size={36} className="text-[#253A7B]" />
      </div>

      <h1 className="font-hedvig text-4xl font-bold text-[#121314] sm:text-5xl">
        Page Not Found
      </h1>
